   ...
   implements SortedSet<E>
{
   ...
   {  return new BinaryTreeIterator(rootNode, "string");
   }
   
   public Iterator<E> DSAiterator(String s)
   {  return new BinaryTreeIterator(rootNode, s);
   }
   ...
   {  // create the binary search tree
      ...
      System.out.print("Subtree iteration preOrder: ");
      Iterator<String> i = ((BinarySearchTree)subtree).DSAiterator("pre");
      while (i.hasNext())
      ...
      System.out.print("Subtree iteration postOrder: ");
      i = ((BinarySearchTree)subtree).DSAiterator("post");
      while (i.hasNext())
      {  System.out.print(i.next());
         if (i.hasNext()) System.out.print(", ");
      }
      ...
      subtree = tree.subSet("cat", "fox");
      System.out.print("Subtree iteration inOrder: ");
      i = ((BinarySearchTree)subtree).DSAiterator("in");
      while (i.hasNext())
      {  System.out.print(i.next());
         if (i.hasNext()) System.out.print(", ");
      }
   ...
   private class BinaryTreeIterator implements Iterator<E>
   {
      ...
      public BinaryTreeIterator(BinaryTreeNode rootNode, String s)
